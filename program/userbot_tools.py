...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        return await user.send_message(chat_id, "اطلق دخول مساعد بوت ثور ⚡")
        ...
        if not admin.can_manage_voice_chats:
            ...
            return await user.send_message(chat_id, "الحساب المسلعد ل ثور هنا بلفعل ⚡️")
        return await user.send_message(chat_id, "ترا هون صديقي ⚡️")
...
async def leave_chat(_, m: Message):
    ...
    try:
        ...
        return await _.send_message(
            chat_id,
            "مساعد بوت ثور تم المغادره ⚡",
        )
    except UserNotParticipant:
        return await _.send_message(
            chat_id,
            "❌ مساعد البوت بالفعل مغادر",
        )
